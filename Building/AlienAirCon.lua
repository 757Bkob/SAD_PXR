...
DefineClass.AlienAirCon = {
	...
	display_name = T(123931995489, --[[ModItemLootDef ScavengeGenericDebris display_name]] "Alien Air Conditioner"),
	description = T(479266936859, --[[ModItemLootDef ScavengeGenericDebris description]] "Maintains room temperature to a desired level. Crafted from Alien materials which enhance the range, effect and overall efficiency of this air conditioning unit beyond believe. Due to the alien technology used it is resistant to all natural disasters and will probably survive a nuclear bomb if I was honest with you. Not to mention it has less power drain than a standard air conditioning unit and rarely needs maintainence, so go ahead, make 200 of them. "),
	menu_display_name = T(437384524319, --[[ModItemLootDef ScavengeGenericDebris menu_display_name]] "Alien Air Conditioner"),
	menu_description = T(367139262104, --[[ModItemLootDef ScavengeGenericDebris menu_description]] "Maintains room temperature to a desired level. Crafted from Alien materials which enhance the range, effect and overall efficiency of this air conditioning unit beyond believe. Due to the alien technology used it is resistant to all natural disasters and will probably survive a nuclear bomb if I was honest with you. Not to mention it has less power drain than a standard air conditioning unit and rarely needs maintainence, so go ahead, make 200 of them. "),
	BuildMenuIcon = "CriminalActivity/AlienAirCon.png",
	BuildMenuPos = 90,
	display_name_pl = T(118439412802, --[[ModItemLootDef ScavengeGenericDebris display_name_pl]] "Alien Air Conditioner"),
