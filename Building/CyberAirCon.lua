...
DefineClass.CyberAirCon = {
	...
	display_name = T(511059626222, --[[ModItemLootDef ScavengeGenericDebris display_name]] "Cyber Air Conditioner"),
	description = T(496952824544, --[[ModItemLootDef ScavengeGenericDebris description]] "Maintains room temperature to a desired level. Crafted from Cyber materials which enhance the range, effect and overall efficiency of this air conditioning unit.\n\n<center><style red>Contraband</style>"),
	menu_display_name = T(433305242824, --[[ModItemLootDef ScavengeGenericDebris menu_display_name]] "Cyber Air Conditioner"),
	menu_description = T(371002271057, --[[ModItemLootDef ScavengeGenericDebris menu_description]] "Maintains room temperature to a desired level. Crafted from Cyber materials which enhance the range, effect and overall efficiency of this air conditioning unit."),
	BuildMenuIcon = "CriminalActivity/CyberAirCon.png",
	BuildMenuPos = 90,
	display_name_pl = T(708751462825, --[[ModItemLootDef ScavengeGenericDebris display_name_pl]] "Cyber Air Conditioner"),
