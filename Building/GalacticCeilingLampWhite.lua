...
DefineClass.GalacticCeilingLampWhite = {
	...
	display_name = T(826443437135, --[[ModItemLootDef ScavengeGenericDebris display_name]] "Galactic Ceiling Light"),
	description = T(302517183302, --[[ModItemLootDef ScavengeGenericDebris description]] "Provides light while working. Requires a ceiling. Due to an advancement in technology these light fixtures drain less electricity and have practically zero chance of malfunctioning. Has light indicators, enhanced range and color options."),
	BuildMenuIcon = "Trade/GalaxyCeilingLightWhite.png",
	BuildMenuPos = 2001,
	display_name_pl = T(162020431129, --[[ModItemLootDef ScavengeGenericDebris display_name_pl]] "Galactic Ceiling Light"),
