...
DefineClass.GalacticCeilingLampYellow = {
	...
	display_name = T(540523221652, --[[ModItemLootDef ScavengeGenericDebris display_name]] "Galactic Ceiling Light"),
	description = T(867563727575, --[[ModItemLootDef ScavengeGenericDebris description]] "Provides light while working. Requires a ceiling. Due to an advancement in technology these light fixtures drain less electricity and have practically zero chance of malfunctioning. Has light indicators, enhanced range and color options."),
	BuildMenuIcon = "Trade/GalaxyCeilingLightYellow.png",
	BuildMenuPos = 2001,
	display_name_pl = T(662086919834, --[[ModItemLootDef ScavengeGenericDebris display_name_pl]] "Galactic Ceiling Light"),
