...
DefineClass.GalacticWallLampBlue = {
	...
	display_name = T(171142887546, --[[ModItemLootDef ScavengeGenericDebris display_name]] "Galactic Wall Light"),
	description = T(389179855497, --[[ModItemLootDef ScavengeGenericDebris description]] "Provides light while working. Requires a wall. Due to an advancement in technology these light fixtures drain less electricity and have practically zero chance of malfunctioning. Has light indicators, enhanced range and color options."),
	BuildMenuIcon = "Trade/GalaxyWallLight.png",
	BuildMenuPos = 2000,
	display_name_pl = T(147535892129, --[[ModItemLootDef ScavengeGenericDebris display_name_pl]] "Galactic Wall Light"),
	display_name_short = T(613051529114, --[[ModItemLootDef ScavengeGenericDebris display_name_short]] "Galactic Wall Light"),
