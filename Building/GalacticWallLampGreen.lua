...
DefineClass.GalacticWallLampGreen = {
	...
	display_name = T(922199415198, --[[ModItemLootDef ScavengeGenericDebris display_name]] "Galactic Wall Light"),
	description = T(684894656754, --[[ModItemLootDef ScavengeGenericDebris description]] "Provides light while working. Requires a wall. Due to an advancement in technology these light fixtures drain less electricity and have practically zero chance of malfunctioning. Has light indicators, enhanced range and color options."),
	BuildMenuIcon = "Trade/GalaxyWallLightGreen.png",
	BuildMenuPos = 2000,
	display_name_pl = T(926060700363, --[[ModItemLootDef ScavengeGenericDebris display_name_pl]] "Galactic Wall Light"),
	display_name_short = T(126211269572, --[[ModItemLootDef ScavengeGenericDebris display_name_short]] "Galactic Wall Light"),
