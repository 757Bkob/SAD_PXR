...
DefineClass.GalacticWallLampPurple = {
	...
	display_name = T(351614154821, --[[ModItemLootDef ScavengeGenericDebris display_name]] "Galactic Wall Light"),
	description = T(805159130825, --[[ModItemLootDef ScavengeGenericDebris description]] "Provides light while working. Requires a wall. Due to an advancement in technology these light fixtures drain less electricity and have practically zero chance of malfunctioning. Has light indicators, enhanced range and color options."),
	BuildMenuIcon = "Trade/GalaxyWallLightPurple.png",
	BuildMenuPos = 2000,
	display_name_pl = T(192061132710, --[[ModItemLootDef ScavengeGenericDebris display_name_pl]] "Galactic Wall Light"),
	display_name_short = T(805683654140, --[[ModItemLootDef ScavengeGenericDebris display_name_short]] "Galactic Wall Light"),
