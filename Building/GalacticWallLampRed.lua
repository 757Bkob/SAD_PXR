...
DefineClass.GalacticWallLampRed = {
	...
	display_name = T(373080040138, --[[ModItemLootDef ScavengeGenericDebris display_name]] "Galactic Wall Light"),
	description = T(766521074270, --[[ModItemLootDef ScavengeGenericDebris description]] "Provides light while working. Requires a wall. Due to an advancement in technology these light fixtures drain less electricity and have practically zero chance of malfunctioning. Has light indicators, enhanced range and color options."),
	BuildMenuIcon = "Trade/GalaxyWallLightRed.png",
	BuildMenuPos = 2000,
	display_name_pl = T(123300110788, --[[ModItemLootDef ScavengeGenericDebris display_name_pl]] "Galactic Wall Light"),
	display_name_short = T(397559633461, --[[ModItemLootDef ScavengeGenericDebris display_name_short]] "Galactic Wall Light"),
