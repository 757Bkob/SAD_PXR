...
DefineClass.GalacticWallLampWhite = {
	...
	display_name = T(683918739576, --[[ModItemLootDef ScavengeGenericDebris display_name]] "Galactic Wall Light"),
	description = T(822816441834, --[[ModItemLootDef ScavengeGenericDebris description]] "Provides light while working. Requires a wall. Due to an advancement in technology these light fixtures drain less electricity and have practically zero chance of malfunctioning. Has light indicators, enhanced range and color options."),
	BuildMenuIcon = "Trade/GalaxyWallLightWhite.png",
	BuildMenuPos = 2000,
	display_name_pl = T(125104811254, --[[ModItemLootDef ScavengeGenericDebris display_name_pl]] "Galactic Wall Light"),
	display_name_short = T(821374159411, --[[ModItemLootDef ScavengeGenericDebris display_name_short]] "Galactic Wall Light"),
