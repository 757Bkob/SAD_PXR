...
DefineClass.GalacticWallLampYellow = {
	...
	display_name = T(682012426054, --[[ModItemLootDef ScavengeGenericDebris display_name]] "Galactic Wall Light"),
	description = T(667517941925, --[[ModItemLootDef ScavengeGenericDebris description]] "Provides light while working. Requires a wall. Due to an advancement in technology these light fixtures drain less electricity and have practically zero chance of malfunctioning. Has light indicators, enhanced range and color options."),
	BuildMenuIcon = "Trade/GalaxyWallLightYellow.png",
	BuildMenuPos = 2000,
	display_name_pl = T(632993613395, --[[ModItemLootDef ScavengeGenericDebris display_name_pl]] "Galactic Wall Light"),
	display_name_short = T(620435881725, --[[ModItemLootDef ScavengeGenericDebris display_name_short]] "Galactic Wall Light"),
