...
DefineClass.GasMine = {
	...
	display_name = T(867159780902, --[[ModItemLootDef ScavengeGenericDebris display_name]] "Gas Mine"),
	description = T(462507207918, --[[ModItemLootDef ScavengeGenericDebris description]] "Simple pressure-activated gas trap. Requires rearming after each use. Has been designed to release toxic chemicals into the air upon being triggered.\n\nStats:\n<style TechSubtitleBlue>- 3 Meter Range.\n- Health Conditions (Damaged Lungs, Shortness of Breath, Pain and Poisoning)\n- Moderate Poisoning - 80% Trigger Chance.\n- Severe Poisoning - 20% Trigger Chance.\n- Extreme Poisoning - 10% Trigger Chance.\n- Instant Death - 2%</style>\n\n<style red>Element:</style> \n<color TextNegative>Blunt</color> | <color TextNegative>Piercing</color> | <color TextNegative>Energy</color> | <color TextPositive>Gas</color> | <color TextNegative>Pacify</color>"),
	menu_display_name = T(630392949715, --[[ModItemLootDef ScavengeGenericDebris menu_display_name]] "Gas Mine"),
	menu_rollover_hint = T(621918044584, --[[ModItemLootDef ScavengeGenericDebris menu_rollover_hint]] "Gas Mine"),
	BuildMenuIcon = "Trade/TrapExplosive2.png",
	BuildMenuPos = 30,
	display_name_pl = T(455949651335, --[[ModItemLootDef ScavengeGenericDebris display_name_pl]] "Gas Mine"),
	entity = "Trap_LandMine",
	update_interval = 3000,
	can_turn_off = true,
	turn_on_text = T(199787407894, --[[ModItemLootDef ScavengeGenericDebris turn_on_text |gender-variants]] "Arm"),
	turn_off_text = T(191982953411, --[[ModItemLootDef ScavengeGenericDebris turn_off_text |gender-variants]] "Disarm"),
	...
	multi_placement_name = T(972762241132, --[[ModItemLootDef ScavengeGenericDebris multi_placement_name]] "mine"),
	multi_placement_name_pl = T(338029937513, --[[ModItemLootDef ScavengeGenericDebris multi_placement_name_pl]] "mines"),
	apply_res_reqs = false,
	progress = 2000,
	range_tags = {
		"combat",
	},
	turning_on_text = T(157643921463, --[[ModItemLootDef ScavengeGenericDebris turning_on_text]] "Waiting to be armed"),
	turning_off_text = T(483263123318, --[[ModItemLootDef ScavengeGenericDebris turning_off_text]] "Waiting to be disarmed"),
	turned_off_warning = "Disarmed",
	turn_on_icon = "UI/Icons/Infopanels/trap_arm",
	turn_off_icon = "UI/Icons/Infopanels/trap_disarm",
	turn_on_description = T(349767435293, --[[ModItemLootDef ScavengeGenericDebris turn_on_description]] "Task the survivors to arm this trap."),
	turn_off_description = T(749668794417, --[[ModItemLootDef ScavengeGenericDebris turn_off_description]] "Task the survivors to disarm this trap."),
