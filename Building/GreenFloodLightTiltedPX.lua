...
DefineClass.GreenFloodLightTiltedPX = {
	...
	display_name = T(858557002714, --[[ModItemLootDef ScavengeGenericDebris display_name]] "Tilted Floodlight"),
	description = T(945191491290, --[[ModItemLootDef ScavengeGenericDebris description]] "Lights up a wide area in front of itself while working. Has extended range, does not malfunction, more durability and drains less electricity."),
	BuildMenuIcon = "Trade/GreenTiltedLight.png",
	BuildMenuPos = 200,
	display_name_pl = T(457841313248, --[[ModItemLootDef ScavengeGenericDebris display_name_pl]] "Tilted Floodlights"),
