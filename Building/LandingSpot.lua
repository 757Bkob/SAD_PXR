...
DefineClass.LandingSpot = {
	...
	display_name = T(141872542351, --[[ModItemLootDef ScavengeGenericDebris display_name]] "Landing Pad"),
	description = T(589958651226, --[[ModItemLootDef ScavengeGenericDebris description]] "A landing site for <color TextEmphasis>supply crates</color>."),
	menu_display_name = T(351158595633, --[[ModItemLootDef ScavengeGenericDebris menu_display_name]] "Landing Spot"),
	BuildMenuIcon = "General/LandingPad.png",
	BuildMenuPos = 100,
	display_name_pl = T(688014067434, --[[ModItemLootDef ScavengeGenericDebris display_name_pl]] "Landing Pad"),
