...
DefineClass.PurpleFloodLightTiltedPX = {
	...
	display_name = T(628812555140, --[[ModItemLootDef ScavengeGenericDebris display_name]] "Tilted Floodlight"),
	description = T(981612966150, --[[ModItemLootDef ScavengeGenericDebris description]] "Lights up a wide area in front of itself while working. Has extended range, does not malfunction, more durability and drains less electricity."),
	BuildMenuIcon = "Trade/PurpleTiltedLight.png",
	BuildMenuPos = 200,
	display_name_pl = T(672056003930, --[[ModItemLootDef ScavengeGenericDebris display_name_pl]] "Tilted Floodlights"),
