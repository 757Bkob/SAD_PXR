...
DefineClass.RedFloodLightTiltedPX = {
	...
	display_name = T(916234646415, --[[ModItemLootDef ScavengeGenericDebris display_name]] "Tilted Floodlight"),
	description = T(928228722702, --[[ModItemLootDef ScavengeGenericDebris description]] "Lights up a wide area in front of itself while working. Has extended range, does not malfunction, more durability and drains less electricity."),
	BuildMenuIcon = "Trade/RedTiltedLight.png",
	BuildMenuPos = 200,
	display_name_pl = T(258257333402, --[[ModItemLootDef ScavengeGenericDebris display_name_pl]] "Tilted Floodlights"),
