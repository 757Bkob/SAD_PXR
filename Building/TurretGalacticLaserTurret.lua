...
DefineClass.TurretGalacticLaserTurret = {
	...
	display_name = T(649047915031, --[[ModItemLootDef ScavengeGenericDebris display_name]] "Wireless Laser Turret"),
	description = T(434699622202, --[[ModItemLootDef ScavengeGenericDebris description]] "<style blue>Wireless Laser Turret</style>\nWireless Automated defense station. Shoots a highly concentrated electrical laser beam at a target in range. Has increased range and damage. Can cause <color TextNegative>laser burns</color>.\n\n<style red>Element:</style> \n<color TextPositive>Blunt</color> | <color TextNegative>Piercing</color> | <color TextPositive>Energy</color> | <color TextNegative>Gas</color> | <color TextNegative>Pacify</color>"),
	menu_display_name = T(914295440271, --[[ModItemLootDef ScavengeGenericDebris menu_display_name]] "Wireless Laser Turret"),
	BuildMenuIcon = "Trade/WirelessTurretsMain.png",
	BuildMenuPos = 30,
	display_name_pl = T(888141710886, --[[ModItemLootDef ScavengeGenericDebris display_name_pl]] "Wireless Laser Turret"),
	display_name_short = T(986715074206, --[[ModItemLootDef ScavengeGenericDebris display_name_short]] "Turret"),
	labels = {
		"CPUCoreDevice",
		"BerserkTargets",
