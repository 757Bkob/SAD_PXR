...
DefineClass.TurretGalacticLaserTurretWired = {
	...
	display_name = T(441810651393, --[[ModItemLootDef ScavengeGenericDebris display_name]] "Wired Laser Turret"),
	description = T(313921701664, --[[ModItemLootDef ScavengeGenericDebris description]] "<style blue>Wired Laser Turret</style>\nWired Automated defense station. Shoots a highly concentrated electrical laser beam at a target in range. Has increased range and damage. Can cause <color TextNegative>laser burns</color>.\n\n<style red>Element:</style> \n<color TextPositive>Blunt</color> | <color TextNegative>Piercing</color> | <color TextPositive>Energy</color> | <color TextNegative>Gas</color> | <color TextNegative>Pacify</color>"),
	menu_display_name = T(827382586792, --[[ModItemLootDef ScavengeGenericDebris menu_display_name]] "Wired Laser Turret"),
	BuildMenuIcon = "Trade/WirelessTurretsMain.png",
	BuildMenuPos = 30,
	display_name_pl = T(893277842950, --[[ModItemLootDef ScavengeGenericDebris display_name_pl]] "Wired Laser Turret"),
	display_name_short = T(797585673753, --[[ModItemLootDef ScavengeGenericDebris display_name_short]] "Turret"),
	labels = {
		"CPUCoreDevice",
		"BerserkTargets",
