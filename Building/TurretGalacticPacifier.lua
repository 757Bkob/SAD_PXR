...
DefineClass.TurretGalacticPacifier = {
	...
	display_name = T(748577233055, --[[ModItemLootDef ScavengeGenericDebris display_name]] "Wireless Pacifier Turret"),
	description = T(231791960847, --[[ModItemLootDef ScavengeGenericDebris description]] "<style blue>Wireless Pacifier Turret</style>\nWireless Automated Pacifier Turret. Shoots rounds of ammunition filled with sedative chemicals that cause sleepiness and paralysis of bodily functions. Inflicts <color TextNegative>pacify</color>. Harmless turret otherwise. Only used to deter wildlife from compounds.\n\n<style red>Element:</style> \n<color TextNegative>Blunt</color> | <color TextNegative>Piercing</color> | <color TextNegative>Energy</color> | <color TextNegative>Gas</color> | <color TextPositive>Pacify</color>"),
	menu_display_name = T(978016664044, --[[ModItemLootDef ScavengeGenericDebris menu_display_name]] "Wireless Pacifier Turret"),
	BuildMenuIcon = "Trade/WirelessTurretsPacifierTurret.png",
	BuildMenuPos = 10,
	display_name_pl = T(469303443454, --[[ModItemLootDef ScavengeGenericDebris display_name_pl]] "Wireless Pacifier Turret"),
	display_name_short = T(414051666264, --[[ModItemLootDef ScavengeGenericDebris display_name_short]] "Pacifier Turret"),
	labels = {
		"CPUCoreDevice",
		"BerserkTargets",
