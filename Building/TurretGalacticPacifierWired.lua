...
DefineClass.TurretGalacticPacifierWired = {
	...
	display_name = T(895934487035, --[[ModItemLootDef ScavengeGenericDebris display_name]] "Wired Pacifier Turret"),
	description = T(339841243466, --[[ModItemLootDef ScavengeGenericDebris description]] "<style blue>Wired Pacifier Turret</style>\nWired Automated Pacifier Turret. Shoots rounds of ammunition filled with sedative chemicals that cause sleepiness and paralysis of bodily functions. Inflicts <color TextNegative>pacify</color>. Harmless turret otherwise. Only used to deter wildlife from compounds.\n\n<style red>Element:</style> \n<color TextNegative>Blunt</color> | <color TextNegative>Piercing</color> | <color TextNegative>Energy</color> | <color TextNegative>Gas</color> | <color TextPositive>Pacify</color>"),
	menu_display_name = T(924497735702, --[[ModItemLootDef ScavengeGenericDebris menu_display_name]] "Wired Pacifier Turret"),
	BuildMenuIcon = "Trade/WirelessTurretsPacifierTurret.png",
	BuildMenuPos = 10,
	display_name_pl = T(383420152106, --[[ModItemLootDef ScavengeGenericDebris display_name_pl]] "Wired Pacifier Turret"),
	display_name_short = T(369738130376, --[[ModItemLootDef ScavengeGenericDebris display_name_short]] "Pacifier Turret"),
	labels = {
		"CPUCoreDevice",
		"BerserkTargets",
