...
DefineClass.TurretGalacticToxic = {
	...
	display_name = T(680716455072, --[[ModItemLootDef ScavengeGenericDebris display_name]] "Wireless Toxic Turret"),
	description = T(979023229595, --[[ModItemLootDef ScavengeGenericDebris description]] "<style blue>Wireless Toxic Turret</style>\nWireless Automated defense station. Shoots rounds of ammunition filled with toxic chemicals that when punctured into the bloodstream can cause <color TextNegative>poisoning</color> and <color TextNegative>paralysis</color>. \n\n<style red>Element:</style> \n<color TextNegative>Blunt</color> | <color TextNegative>Piercing</color> | <color TextNegative>Energy</color> | <color TextPositive>Gas</color> | <color TextNegative>Pacify</color>"),
	menu_display_name = T(530212275422, --[[ModItemLootDef ScavengeGenericDebris menu_display_name]] "Wireless Toxic Turret"),
	BuildMenuIcon = "Trade/WirelessTurretsMachinegun.png",
	BuildMenuPos = 10,
	display_name_pl = T(764802248276, --[[ModItemLootDef ScavengeGenericDebris display_name_pl]] "Wireless Toxic Turret"),
	display_name_short = T(191916474718, --[[ModItemLootDef ScavengeGenericDebris display_name_short]] "Turret"),
	labels = {
		"CPUCoreDevice",
		"BerserkTargets",
