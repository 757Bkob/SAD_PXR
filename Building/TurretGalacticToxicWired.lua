...
DefineClass.TurretGalacticToxicWired = {
	...
	display_name = T(306725494660, --[[ModItemLootDef ScavengeGenericDebris display_name]] "Wired Toxic Turret"),
	description = T(440160380813, --[[ModItemLootDef ScavengeGenericDebris description]] "<style blue>Wired Toxic Turret</style>\nWired Automated defense station. Shoots rounds of ammunition filled with toxic chemicals that when punctured into the bloodstream can cause <color TextNegative>poisoning</color> and <color TextNegative>paralysis</color>. \n\n<style red>Element:</style> \n<color TextNegative>Blunt</color> | <color TextNegative>Piercing</color> | <color TextNegative>Energy</color> | <color TextPositive>Gas</color> | <color TextNegative>Pacify</color>"),
	menu_display_name = T(462864393198, --[[ModItemLootDef ScavengeGenericDebris menu_display_name]] "Wired Toxic Turret"),
	BuildMenuIcon = "Trade/WirelessTurretsMachinegun.png",
	BuildMenuPos = 10,
	display_name_pl = T(230600755293, --[[ModItemLootDef ScavengeGenericDebris display_name_pl]] "Wired Toxic Turret"),
	display_name_short = T(904357550294, --[[ModItemLootDef ScavengeGenericDebris display_name_short]] "Turret"),
	labels = {
		"CPUCoreDevice",
		"BerserkTargets",
