...
DefineClass.WhiteFloodLightTiltedPX = {
	...
	display_name = T(488355200219, --[[ModItemLootDef ScavengeGenericDebris display_name]] "Tilted Floodlight"),
	description = T(942531566064, --[[ModItemLootDef ScavengeGenericDebris description]] "Lights up a wide area in front of itself while working. Has extended range, does not malfunction, more durability and drains less electricity."),
	BuildMenuIcon = "Trade/WhiteTiltedLight.png",
	BuildMenuPos = 200,
	display_name_pl = T(581114897543, --[[ModItemLootDef ScavengeGenericDebris display_name_pl]] "Tilted Floodlights"),
