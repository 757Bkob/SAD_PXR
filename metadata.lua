return PlaceObj('ModDef', {
	...
	'last_changes', "<em>5.5.2 Bugfixes</em>\n#1. Bugfix: Fixed the cyber pendant\n\n#2. Bugfix:  Added control circuit toggle to Gal Laz Barrier\n\n#3. Bugfix:  Fixed bug trying to attack/evolve a non-existent Tecatli unit\n\n#4. Bugfix:  Post-signal relay attacks fixed. TL:DR It will work now\nA. Moved all attack spawning code down to the lua file itself (So I can see / test it easier)\nB. Code uses new EE evo chain code\nC. No longer hard-coded animal ids (Which apparently can change)\n\n#5. Bugfix:  Copy button toggled on for the trade console\n\n#6. Bugfix: Fixed the calling of the Colony Ship (I had a space where the game expected none)\n\n#7. Bugfix:  Matter Fabs are not hidden by default, but have conditions that will hide them, and conditions that unlock them. (Old way was on tech research, remove the hide/lock. But that is what is causing issues)",
	'id', "ucCehPy",
	'author', "Ark Builder",
	'version_major', 5,
	'version_minor', 5,
