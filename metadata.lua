return PlaceObj('ModDef', {
	...
	'last_changes', "<em>5.5.4</em>\n\n#1. Bugfix: The local gravity well will correctly let you contact ships in orbit.\n(it's fixed for realzies this time)\n\n#2. Bugfix: Alien Crystal Generator now takes 1/10 the research time to complete (41 days -> 4 days)\n\n#3. QoL: Haunted happiness debuff 40% -> 20%. Haunted trait & happiness description(s) updated to show the manipulation boost (150%).",
	'id', "ucCehPy",
	'author', "Ark Builder",
	'version_major', 5,
	'version_minor', 5,
