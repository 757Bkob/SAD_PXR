return PlaceObj('ModDef', {
	...
	'last_changes', '<em>5.5.3 Minor Update Hotfix B</em>\n\nB1. Bugfix: Removed errant print statement when ships in orbit event occured\n\nA1. Bugfix: Fixed ships never entering/leaving orbit after the game started.\n(Fixed the lua code incorrectly calling old function name.)\n\n#1. Content Change: Organs can now be collected via a specific post-animal death action called "Dissect".\nOr when tamed, via a new slaughter variant action.\nDetails on the organ amounts gained via this action can be found at the organ rework steam mod discussions.\nTL:DR You gain more organs if the animal is a higher tier, the animal is one that attacks you (aka a predator), the colonist has the correct tool equipped, and the colonist has a high biology skill, and the colonist has a tangentially related trait.\nGenerally a T5 predator with all conditions met will net 100 organs of each type.\nBUT with no conditions met, the output will be 1-2 organs of each type.\nThis is to ramp the resource extraction the later the game goes, and reward early investments into biology/taming high tiers of predators.\n(For more details, I will be opening up a discussion on the steam forums for Q/A & spoilers)\n\n2. Bugfix: Ships in orbit now properly are called and ca be talked with\n\n3. Bugfix: All attacking units now share the same combat group, instead of their specific species combat group',
	'id', "ucCehPy",
	'author', "Ark Builder",
	'version_major', 5,
	'version_minor', 5,
	...
	'code', {
		"Code/PXR_General_Lua.lua",
		"Code/PXR_organ_dissection.lua",
		"Code/PXR_Local_Orbit.lua",
